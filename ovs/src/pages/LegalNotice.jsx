...
function LegalNotice() {
  return (
    <div>
        <p style={{ color: 'black' }}>
        <b>
          <span style={{ text: '2xl' }}>Mentions légales</span>{' '}
        </b>
      </p>
      <br />
      ...
      internet <a href="http://www.onvasporter.link">
        www.onvasporter.link
      </a>{' '}
      sont :
      ...
      ECP-Team Numéro de SIRET : 0125122365455656 Responsable editorial : DJTAJJ
      6 rue St Jean d'Angely Téléphone :0493123456 - Fax : 0493123456 Email :
      contact@onvasporter.link Site Web :{' '}
      <a href="http://www.onvasporter.link">www.onvasporter.link</a>
      <br />
      <br/>
      <p style={{ color: '#b51a00' }}>
        <b>
      ...
      Hébergeur : Hebergeur 123 rue de l'hébergeur Site Web :{' '}
      <a href="http://www.hebergeur.com">www.hebergeur.com</a>
      <br />
      <p style={{ color: '#b51a00' }}>
        <span style={{ color: 'rgb(0, 0, 0)' }}>
          <br />
      ...
      ECP-Team Adresse : 19/21 Chemin Sorgentino Site Web :{' '}
      <a href="http://www.ecp-team.com">www.ecp-team.com</a>
      <br />
      <p style={{ color: '#b51a00' }}>
        <span style={{ color: 'rgb(0, 0, 0)' }}>
          <br />
      ...
      Ce site (<a href="http://www.onvasporter.link">www.onvasporter.link</a>)
      ...
      <br />
      <b>Cookies</b> : Le site{' '}
      <a href="http://www.onvasporter.link">www.onvasporter.link</a> peut-être
      ...
      Internet. ECP-Team ne dispose d'aucun moyen pour contrôler les sites en
      connexion avec ses sites internet. ne répond pas de la disponibilité de
      tels sites et sources externes, ni ne la garantit. Elle ne peut être tenue
      pour responsable de tout dommage, de quelque nature que ce soit, résultant
      du contenu de ces sites ou sources externes, et notamment des
      informations, produits ou services qu’ils proposent, ou de tout usage qui
      peut être fait de ces éléments. Les risques liés à cette utilisation
      incombent pleinement à l'internaute, qui doit se conformer à leurs
      conditions d'utilisation. Les utilisateurs, les abonnés et les visiteurs
      des sites internet de ne peuvent mettre en place un hyperlien en direction
      de ce site sans l'autorisation expresse et préalable de ECP-Team. Dans
      l'hypothèse où un utilisateur ou visiteur souhaiterait mettre en place un
      hyperlien en direction d’un des sites internet de ECP-Team, il lui
      appartiendra d'adresser un email accessible sur le site afin de formuler
      sa demande de mise en place d'un hyperlien. ECP-Team se réserve le droit
      ...
      <p style={{ color: '#323333' }}>
        ECP-Team s’efforce de fournir sur le site www.onvasporter.link des
        informations aussi précises que possible. les renseignements figurant
        sur le site{' '}
        <a href="http://www.onvasporter.link">www.onvasporter.link</a> ne sont
      ...
      bien vouloir le signaler par email, à l’adresse contact@onvasporter.link,
      en décrivant le problème de la manière la plus précise possible (page
      posant problème, type d’ordinateur et de navigateur utilisé, …). Tout
      contenu téléchargé se fait aux risques et périls de l'utilisateur et sous
      sa seule responsabilité. En conséquence, ne saurait être tenu responsable
      ...
      sauraient engager la responsabilité de ECP-Team.
      <br />
      <p style={{ color: '#b51a00' }}>
        <span style={{ color: 'rgb(0, 0, 0)' }}>
          <br />
      ...
      <a href="http://www.onvasporter.link">www.onvasporter.link</a>, incluant,
      ...
      interdite sans l'accord exprès par écrit de ECP-Team. Cette représentation
      ...
      propriété intellectuelle. Le non-respect de cette interdiction constitue
      ...
      d'une déclaration 123456789 auprès de la Commission nationale de
      ...
      <a href="http://www.onvasporter.link">www.onvasporter.link</a> sont régies
      ...
      <a href="http://www.onvasporter.link">www.onvasporter.link</a>. Cependant,
